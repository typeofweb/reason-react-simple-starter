...
function make() {
  ...
  newrecord[/* render */9] = (function (param) {
      ...
      var d = MomentWithDate(new Date());
      return React.createElement("div", undefined, React.createElement("button", {
                      onClick: Curry._1(param[/* reduce */3], (function () {
                              return /* Click */1;
                            }))
                    }, "Click"), React.createElement("p", undefined, timeMessage), React.createElement("p", undefined, counterMessage), React.createElement("p", undefined, d.format("dddd")));
    });
